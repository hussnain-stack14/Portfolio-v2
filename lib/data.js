...
export const sidebarContacts = [
  ...
  { label: 'Birthday', value: profile.birthday, icon: Cake },
...
export const services = [
  {
    ...
    description: 'Modern, scalable web apps built with clean, maintainable architecture.',
  ...
  },
  {
    ...
    description: 'Building and testing REST APIs for seamless app communication.',
  ...
  },
  {
    ...
    description: 'Clear documentation that makes systems easy to understand and maintain.',
    icon: <FileText className="w-14 h-14 text-primary" />,
  },
];

export const testimonials = [
  { name: 'client', quote: 'Great communication and delivered exactly what was needed for the project.', avatar: 'https://images.unsplash.com/photo-1544005313-94ddf0286df2?auto=format&fit=crop&w=200&q=80' },
  { name: 'client', quote: 'Reliable, detail-oriented, and easy to work with throughout the project.', avatar: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?auto=format&fit=crop&w=200&q=80' },
];
...
export const skills = [
  ...
  { label: 'AES Encryption', percent: 70, category: 'Concepts' },
