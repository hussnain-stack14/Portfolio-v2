...
export const services = [
  {
    ...
    description:
      'Modern, responsive websites that help businesses, startups, and personal brands build a strong online presence.',
...
export const projects = [
  ...
  { title: 'POS system', category: 'Dashboard', thumbnail: '/images/POS.jpg', link: 'https://pos-business.netlify.app/', accent: 'from-amber-500 to-orange-500' },
  { title: 'Hot Sauce', category: 'Business Websites', thumbnail: '/images/hot-sauce.jpg', link: 'https://www.figma.com/make/pKRtxx9nYpQmipAGFn4kGD/Pizza-Restaurant-Landing-Page?fullscreen=1&t=Xdp58XEhbiYySTrh-1&code-node-id=0-6', accent: 'from-rose-500 to-pink-500' },
  { title: 'Vertex CRM', category: 'Web Application', thumbnail: '/images/project-6.svg', link: '#', accent: 'from-indigo-500 to-violet-500' },
];

export const filters = ['All', 'Website', 'Web Application', 'Dashboard', 'Ecommerce', 'Chat App', 'Business Websites'];